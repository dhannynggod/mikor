...
class M_Admin extends CI_Model
{
  ...
  function update_table($table_name, $where, $id_login, $data)
  {
    $this->db->where($where, $id_login);
  ...
  {
    $sql = "SELECT COUNT(id_anggota) as user FROM user";
    $result = $this->db->query($sql);
    return $result->row();
  }
  public function getCountBarang()
  {
    $sql = "SELECT COUNT(barang_id) as barang FROM barang";
    $result = $this->db->query($sql);
    return $result->row();
  }
  ...
  {
    $sql = "SELECT COUNT(status) as pinjam
    FROM pinjam
  ...
  {
    $sql = "SELECT COUNT(status) as kembali
    FROM pinjam
